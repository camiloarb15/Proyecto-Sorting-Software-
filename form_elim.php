...
<body>
  ...
  <h2 class="content-head is-center">Eliminar un libro</h2>
  <form class="pastelito" action="eliminar.php" method="POST">
    <input class="entrada" type="text" name="id_libro" placeholder="Ingrese codigo de libro a eliminar"><br><br>
    <input class="botonl" type="submit" value="Eliminar" class="btn btn_info" name="btn_eliminar">
  </form>
